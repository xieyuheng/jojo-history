...
*** a syntax to get literal python function

*** (call)

    - (call <fun> .arg1 .arg2)

    - this provide us a way to use
      python function which has default arguments

*** start jojo-in-javascript

*** use python to normalize features

*** to handle (. .field .field <type>) in (-> ...)
...
*** >< (call)
    ...
    - push default arguments to stack
