...
*** now now
    ...
    - core.jo
      move recursive functions about vect and list to core.jo

    - do not view tuple result as multiple-return-value
      use a interface class for that

*** cover python's builtin classes and their methods

    - to be able to (+method) to them
...
*** cover python's builtin functions

*** cover python's standard libraries
